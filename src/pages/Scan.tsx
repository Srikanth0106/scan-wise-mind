...
export default function Scan() {
  ...
  const handleReset = () => { setResumeId(null); setResume(null); };
      ...
      {!resume ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 h-[calc(100vh-180px)]">
          ...
          <div className="min-h-0">
            <AIChatBox resumeId={resume.id} resumeText={resume.resume_text || ""} candidateName={resume.candidate_name || "Unknown"} />
          </div>
        </div>
      )}
    </div>
